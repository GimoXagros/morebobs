...
if mods["DeadlockStacking"] then
	...
	if data.raw["item"]["bauxite-ore"] then 
		deadlock_stacking.create("bauxite-ore", "__morebobs_bobsStackCrate__/graphics/icons/stacking/ores/bob/bauxite-ore.png", "deadlock-stacking-1", 32)
	end
	if data.raw["item"]["cobalt-ore"] then 
		deadlock_stacking.create("cobalt-ore", "__morebobs_bobsStackCrate__/graphics/icons/stacking/ores/bob/cobalt-ore.png", "deadlock-stacking-1", 32)
	end
	if data.raw["item"]["gem-ore"] then 
		deadlock_stacking.create("gem-ore", "__morebobs_bobsStackCrate__/graphics/icons/stacking/ores/bob/gem-ore.png", "deadlock-stacking-1", 32)
	end
	if data.raw["item"]["gold-ore"] then 
		deadlock_stacking.create("gold-ore", "__morebobs_bobsStackCrate__/graphics/icons/stacking/ores/bob/gold-ore.png", "deadlock-stacking-1", 32)
	end
	if data.raw["item"]["lead-ore"] then 
		deadlock_stacking.create("lead-ore", "__morebobs_bobsStackCrate__/graphics/icons/stacking/ores/bob/lead-ore.png", "deadlock-stacking-1", 32)
	end
	if data.raw["item"]["nickel-ore"] then 
		deadlock_stacking.create("nickel-ore", "__morebobs_bobsStackCrate__/graphics/icons/stacking/ores/bob/nickel-ore.png", "deadlock-stacking-1", 32)
	end
	if data.raw["item"]["quartz"] then 
		deadlock_stacking.create("quartz", "__morebobs_bobsStackCrate__/graphics/icons/stacking/ores/bob/quartz.png", "deadlock-stacking-1", 32)
	end
	if data.raw["item"]["rutile-ore"] then 
		deadlock_stacking.create("rutile-ore", "__morebobs_bobsStackCrate__/graphics/icons/stacking/ores/bob/rutile-ore.png", "deadlock-stacking-1", 32)
	end
	if data.raw["item"]["silver-ore"] then 
		deadlock_stacking.create("silver-ore", "__morebobs_bobsStackCrate__/graphics/icons/stacking/ores/bob/silver-ore.png", "deadlock-stacking-1", 32)
	end
	if data.raw["item"]["thorium-ore"] then 
		deadlock_stacking.create("thorium-ore", "__morebobs_bobsStackCrate__/graphics/icons/stacking/ores/bob/thorium-ore.png", "deadlock-stacking-1", 32)
	end
	if data.raw["item"]["tin-ore"] then 
		deadlock_stacking.create("tin-ore", "__morebobs_bobsStackCrate__/graphics/icons/stacking/ores/bob/tin-ore.png", "deadlock-stacking-1", 32)
	end
	if data.raw["item"]["tungsten-ore"] then 
		deadlock_stacking.create("tungsten-ore", "__morebobs_bobsStackCrate__/graphics/icons/stacking/ores/bob/tungsten-ore.png", "deadlock-stacking-1", 32)
	end
	if data.raw["item"]["zinc-ore"] then 
		deadlock_stacking.create("zinc-ore", "__morebobs_bobsStackCrate__/graphics/icons/stacking/ores/bob/zinc-ore.png", "deadlock-stacking-1", 32)
	end
	...
	if data.raw["item"]["cobalt-steel-alloy"] then 
		deadlock_stacking.create("cobalt-steel-alloy", "__morebobs_bobsStackCrate__/graphics/icons/stacking/plates/stacked-cobalt-steel-alloy.png", "deadlock-stacking-3", 32)
	end
	...
	if data.raw["item"]["titanium-plate"] then 
		deadlock_stacking.create("titanium-plate", "__morebobs_bobsStackCrate__/graphics/icons/stacking/plates/stacked-titanium-plate.png", "deadlock-stacking-4", 32)
	end
	if data.raw["item"]["tungsten-plate"] then 
		deadlock_stacking.create("tungsten-plate", "__morebobs_bobsStackCrate__/graphics/icons/stacking/plates/stacked-tungsten-plate.png", "deadlock-stacking-4", 32)
	end
	...
	if data.raw["item"]["nitinol-alloy"] then 
		deadlock_stacking.create("nitinol-alloy", "__morebobs_bobsStackCrate__/graphics/icons/stacking/plates/stacked-nitinol-alloy.png", "deadlock-stacking-5", 32)
	end
	...
	if data.raw["item"]["resin"] then 
		deadlock_stacking.create("resin", nil, "deadlock-stacking-1")
	end
	...
	if data.raw["item"]["enriched-fuel"] then 
		deadlock_stacking.create("enriched-fuel", "__morebobs_bobsStackCrate__/graphics/icons/stacking/plates/stacked-enriched-fuel.png", "deadlock-stacking-4", 32)
	end
	if data.raw["item"]["basic-electronic-components"] then 
		deadlock_stacking.create("basic-electronic-components", "__morebobs_bobsStackCrate__/graphics/icons/stacking/electronics/stacked-basic-electronic-components.png", "deadlock-stacking-4", 32)
	end
	if data.raw["item"]["electronic-components"] then 
		deadlock_stacking.create("electronic-components", "__morebobs_bobsStackCrate__/graphics/icons/stacking/electronics/stacked-electronic-components.png", "deadlock-stacking-4", 32)
	end
	if data.raw["item"]["intergrated-electronics"] then 
		deadlock_stacking.create("intergrated-electronics", "__morebobs_bobsStackCrate__/graphics/icons/stacking/electronics/stacked-intergrated-electronics.png", "deadlock-stacking-4", 32)
	end
	if data.raw["item"]["processing-electronics"] then 
		deadlock_stacking.create("processing-electronics", "__morebobs_bobsStackCrate__/graphics/icons/stacking/electronics/stacked-processing-electronics.png", "deadlock-stacking-4", 32)
	end

	-- Bobs gear and bearing
	if data.raw["item"]["steel-gear-wheel"] then 
		deadlock_stacking.create("steel-gear-wheel", "__morebobs_bobsStackCrate__/graphics/icons/stacking/gearbearing/steel-gear-wheel.png", "deadlock-stacking-2", 32)
	end
	if data.raw["item"]["brass-gear-wheel"] then 
		deadlock_stacking.create("brass-gear-wheel", "__morebobs_bobsStackCrate__/graphics/icons/stacking/gearbearing/brass-gear-wheel.png", "deadlock-stacking-2", 32)
	end
	if data.raw["item"]["cobalt-steel-gear-wheel"] then 
		deadlock_stacking.create("cobalt-steel-gear-wheel", "__morebobs_bobsStackCrate__/graphics/icons/stacking/gearbearing/cobalt-steel-gear-wheel.png", "deadlock-stacking-3", 32)
	end
	if data.raw["item"]["titanium-gear-wheel"] then 
		deadlock_stacking.create("titanium-gear-wheel", "__morebobs_bobsStackCrate__/graphics/icons/stacking/gearbearing/titanium-gear-wheel.png", "deadlock-stacking-4", 32)
	end
	if data.raw["item"]["tungsten-gear-wheel"] then 
		deadlock_stacking.create("tungsten-gear-wheel", "__morebobs_bobsStackCrate__/graphics/icons/stacking/gearbearing/tungsten-gear-wheel.png", "deadlock-stacking-4", 32)
	end
	if data.raw["item"]["nitinol-gear-wheel"] then 
		deadlock_stacking.create("nitinol-gear-wheel", "__morebobs_bobsStackCrate__/graphics/icons/stacking/gearbearing/nitinol-gear-wheel.png", "deadlock-stacking-5", 32)
	end
	...
	if settings.startup["moreshinybobs-gfx-intermediates"] and settings.startup["moreshinybobs-gfx-intermediates"].value == true then
		if data.raw["item"]["lithium-ion-battery"] then 
			deadlock_stacking.create("lithium-ion-battery", "__morebobs_bobsStackCrate__/graphics/icons/stacking/battery/battery-2S.png", "deadlock-stacking-3", 32)
		end
		if data.raw["item"]["silver-zinc-battery"] then 
			deadlock_stacking.create("silver-zinc-battery", "__morebobs_bobsStackCrate__/graphics/icons/stacking/battery/battery-3S.png", "deadlock-stacking-3", 32)
		end
	else
		if data.raw["item"]["lithium-ion-battery"] then 
			deadlock_stacking.create("lithium-ion-battery", "__morebobs_bobsStackCrate__/graphics/icons/stacking/battery/lithium-ion-battery.png", "deadlock-stacking-3", 32)
		end
		if data.raw["item"]["silver-zinc-battery"] then 
			deadlock_stacking.create("silver-zinc-battery", "__morebobs_bobsStackCrate__/graphics/icons/stacking/battery/silver-zinc-battery.png", "deadlock-stacking-3", 32)
		end
	end
end
...
if mods["DeadlockCrating"] then
	...
	if data.raw["item"]["resin"] then 
		deadlock_crating.create("resin", "deadlock-crating-1")
	end
	if data.raw["item"]["alumina"] then 
