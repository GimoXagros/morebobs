data:extend({ 
  --tank-recall
  {
    type = "technology",
    name = "tank-recall",
    icon = "__morebobs__/graphics/technology/tank-recall-tokenT.png",
	  icon_size = 128,
  ...
  --modular-tank-research
  {
    ...
    icon = "__morebobs__/graphics/technology/modular-tank-research.png",
	  icon_size = 128,
    effects =
    {
      {
  ...
  --mechanized-infantry-research
  {
    ...
    icon = "__morebobs__/graphics/technology/mech-inf.png",
		icon_size = 128,
    effects =
    {
      {
        type = "unlock-recipe",
        recipe = "repair-capsule"
      },
      {
        type = "unlock-recipe",
        recipe = "fish-kit"
  ...
  --new-munitions
  {
    type = "technology",
    name = "new-munitions",
    icon = "__morebobs__/graphics/technology/chemical-tank-research.png",
		icon_size = 128,
    effects =
    {
			{
  ...
  --organic-explosives
  {
		...
		icon = "__morebobs__/graphics/technology/universal-explosiveT.png",
		icon_size = 384,
		effects =
    {
			{
  ...
  --super-tank-research
  {
		...
		icon = "__morebobs__/graphics/technology/super-tank-research.png",
		icon_size = 128,
		effects =
    {
      {
        type = "unlock-recipe",
        recipe = "tank-super-chassis"
      },
      {
        type = "unlock-recipe",
        recipe = "tank-super-turret"
      },
      {
        type = "unlock-recipe",
        recipe = "super-tank"
...
--Iron wall
  {
		type = "technology",
		name = "iron-walls",
		icon = "__morebobs__/graphics/technology/iron-walls.png",
		icon_size = 128,
		effects =
    {
      {
