--warfare
--gun
if data.raw["item"]["pistol"] then data.raw["item"]["pistol"].icon = "__morebobs__/graphics/moreshiny/icons/warfare/pistol.png" end
if data.raw["item"]["pistol"] then data.raw["item"]["pistol"].icon_size = 32 end

if data.raw["item"]["submachine-gun"] then data.raw["item"]["submachine-gun"].icon = "__morebobs__/graphics/moreshiny/icons/warfare/submachine-gun.png" end
if data.raw["item"]["submachine-gun"] then data.raw["item"]["submachine-gun"].icon_size = 32 end

if data.raw["item"]["shotgun"] then data.raw["item"]["shotgun"].icon = "__morebobs__/graphics/moreshiny/icons/warfare/shotgun.png" end
if data.raw["item"]["shotgun"] then data.raw["item"]["shotgun"].icon_size = 32 end

if data.raw["item"]["rocket-launcher"] then data.raw["item"]["rocket-launcher"].icon = "__morebobs__/graphics/moreshiny/icons/warfare/rocket-launcher.png" end
if data.raw["item"]["rocket-launcher"] then data.raw["item"]["rocket-launcher"].icon_size = 32 end

--mine
if data.raw["item"]["land-mine"] then data.raw["item"]["land-mine"].icon = "__morebobs__/graphics/moreshiny/icons/warfare/land-mine.png" end
if data.raw["item"]["land-mine"] then data.raw["item"]["land-mine"].icon_size = 32 end

if data.raw["item"]["poison-mine"] then data.raw["item"]["poison-mine"].icon = "__morebobs__/graphics/moreshiny/icons/warfare/land-mine-poison.png" end
if data.raw["item"]["poison-mine"] then data.raw["item"]["poison-mine"].icon_size = 32 end

if data.raw["item"]["slowdown-mine"] then data.raw["item"]["slowdown-mine"].icon = "__morebobs__/graphics/moreshiny/icons/warfare/land-mine-slowdown.png" end
if data.raw["item"]["slowdown-mine"] then data.raw["item"]["slowdown-mine"].icon_size = 32 end

if data.raw["item"]["distractor-mine"] then data.raw["item"]["distractor-mine"].icon = "__morebobs__/graphics/moreshiny/icons/warfare/land-mine-distractor.png" end
if data.raw["item"]["distractor-mine"] then data.raw["item"]["distractor-mine"].icon_size = 32 end

--wall
if data.raw["item"]["reinforced-wall"] then data.raw["item"]["reinforced-wall"].icon = "__morebobs__/graphics/moreshiny/icons/warfare/reinforced-wall.png" end
if data.raw["item"]["reinforced-wall"] then data.raw["item"]["reinforced-wall"].icon_size = 32 end

if data.raw["item"]["reinforced-gate"] then data.raw["item"]["reinforced-gate"].icon = "__morebobs__/graphics/moreshiny/icons/warfare/reinforced-gate.png" end
if data.raw["item"]["reinforced-gate"] then data.raw["item"]["reinforced-gate"].icon_size = 32 end

--capsule
if data.raw["capsule"]["poison-capsule"] then data.raw["capsule"]["poison-capsule"].icon = "__morebobs__/graphics/moreshiny/icons/warfare/poison-capsule.png" end
if data.raw["capsule"]["poison-capsule"] then data.raw["capsule"]["poison-capsule"].icon_size = 32 end

if data.raw["capsule"]["slowdown-capsule"] then data.raw["capsule"]["slowdown-capsule"].icon = "__morebobs__/graphics/moreshiny/icons/warfare/slowdown-capsule.png" end
if data.raw["capsule"]["slowdown-capsule"] then data.raw["capsule"]["slowdown-capsule"].icon_size = 32 end

if data.raw["capsule"]["defender-capsule"] then data.raw["capsule"]["defender-capsule"].icon = "__morebobs__/graphics/moreshiny/icons/warfare/defender-capsule.png" end
...
if data.raw["projectile"]["defender-capsule"] then
	...
	{
		filename = "__morebobs__/graphics/moreshiny/icons/warfare/defender-capsule.png",
		frame_count = 1,
		width = 32,
		height = 32,
		priority = "high"
	...
	{
		filename = "__morebobs__/graphics/moreshiny/icons/warfare/combat-robot-capsule-shadow.png",
		frame_count = 1,
		width = 32,
		height = 32,
		priority = "high"
...
if data.raw["capsule"]["distractor-capsule"] then data.raw["capsule"]["distractor-capsule"].icon = "__morebobs__/graphics/moreshiny/icons/warfare/distractor-capsule.png" end
...
if data.raw["projectile"]["distractor-capsule"] then
	...
	{
		filename = "__morebobs__/graphics/moreshiny/icons/warfare/distractor-capsule.png",
		frame_count = 1,
		width = 32,
		height = 32,
		priority = "high"
...
if data.raw["capsule"]["destroyer-capsule"] then data.raw["capsule"]["destroyer-capsule"].icon = "__morebobs__/graphics/moreshiny/icons/warfare/destroyer-capsule.png" end
...
if data.raw["projectile"]["destroyer-capsule"] then
	...
	{
		filename = "__morebobs__/graphics/moreshiny/icons/warfare/destroyer-capsule.png",
		frame_count = 1,
		width = 32,
		height = 32,
		priority = "high"
...
if data.raw["capsule"]["bob-laser-robot-capsule"] then data.raw["capsule"]["bob-laser-robot-capsule"].icon = "__morebobs__/graphics/moreshiny/icons/warfare/laser-robot-capsule.png" end
...
if data.raw["projectile"]["bob-laser-robot-capsule"] then
	...
	{
		filename = "__morebobs__/graphics/moreshiny/icons/warfare/laser-robot-capsule.png",
		frame_count = 1,
		width = 32,
		height = 32,
		priority = "high"
...
if data.raw["item"]["bob-robot-tank"] then
	data.raw["item"]["bob-robot-tank"].icon = "__morebobs__/graphics/moreshiny/icons/warfare/drone.png"
	data.raw["item"]["bob-robot-tank"].icon_size = 32 
end

--robots
if data.raw["item"]["defender-robot"] then
	data.raw["item"]["defender-robot"].icon = "__morebobs__/graphics/moreshiny/icons/warfare/defender.png"
	data.raw["item"]["defender-robot"].icon_size = 32 
	data.raw["combat-robot"]["defender"].icon = "__morebobs__/graphics/moreshiny/icons/warfare/defender.png"
	data.raw["combat-robot"]["defender"].icon_size = 32 
end

if data.raw["item"]["distractor-robot"] then
	data.raw["item"]["distractor-robot"].icon = "__morebobs__/graphics/moreshiny/icons/warfare/distractor.png"
	data.raw["item"]["distractor-robot"].icon_size = 32 
	data.raw["combat-robot"]["distractor"].icon = "__morebobs__/graphics/moreshiny/icons/warfare/distractor.png"
	data.raw["combat-robot"]["distractor"].icon_size = 32 
end

if data.raw["item"]["destroyer-robot"] then
	data.raw["item"]["destroyer-robot"].icon = "__morebobs__/graphics/moreshiny/icons/warfare/destroyer.png"
	data.raw["item"]["destroyer-robot"].icon_size = 32 
	data.raw["combat-robot"]["destroyer"].icon = "__morebobs__/graphics/moreshiny/icons/warfare/destroyer.png"
	data.raw["combat-robot"]["destroyer"].icon_size = 32 
end

if data.raw["item"]["bob-laser-robot"] then
	if not mods["ShinyBobGFX"] then
		data.raw["item"]["bob-laser-robot"].icon = "__morebobs__/graphics/moreshiny/icons/warfare/laser-robot.png"
		data.raw["item"]["bob-laser-robot"].icon_size = 32 
		data.raw["combat-robot"]["bob-laser-robot"].icon = "__morebobs__/graphics/moreshiny/icons/warfare/laser-robot.png"
		...
		data.raw["item"]["bob-laser-robot"].icon = "__morebobs__/graphics/moreshiny/icons/warfare/laser-robot-sh.png"
		data.raw["item"]["bob-laser-robot"].icon_size = 32 
		data.raw["combat-robot"]["bob-laser-robot"].icon = "__morebobs__/graphics/moreshiny/icons/warfare/laser-robot-sh.png"
		data.raw["combat-robot"]["bob-laser-robot"].icon_size = 32
		data.raw["combat-robot"]["bob-laser-robot"].idle = 
		{
		  layers =
		  {
				{
					filename = "__morebobs__/graphics/moreshiny/entity/robots/combot-1.png",
					priority = "high",
					width = 44,
					height = 44,
					frame_count = 1,
					direction_count = 1,
					hr_version = {
						filename = "__morebobs__/graphics/moreshiny/entity/robots/hr-combot-2.png",
						priority = "high",
						width = 88,
						height = 88,
						frame_count = 1,
				...
				{
					filename = "__morebobs__/graphics/moreshiny/entity/robots/laser-robot-sh-mask.png",
					priority = "high",
					width = 44,
					height = 44,
					frame_count = 1,
					...
					apply_runtime_tint = true,
					hr_version = {
						filename = "__morebobs__/graphics/moreshiny/entity/robots/hr-laser-robot-sh-mask.png",
						priority = "high",
						width = 88,
						height = 88,
						frame_count = 1,
...
if not mods["ShinyBobGFX"] then
	if data.raw["ammo"]["bob-rocket"] then
		data.raw["ammo"]["bob-rocket"].icon = "__morebobs__/graphics/moreshiny/icons/warfare/rocket.png"
		data.raw["ammo"]["bob-rocket"].icon_size = 32
	end
	if data.raw["ammo"]["bob-piercing-rocket"] then
		data.raw["ammo"]["bob-piercing-rocket"].icon = "__morebobs__/graphics/moreshiny/icons/warfare/piercing-rocket.png"
		data.raw["ammo"]["bob-piercing-rocket"].icon_size = 32
	end
	if data.raw["ammo"]["bob-flame-rocket"] then
		data.raw["ammo"]["bob-flame-rocket"].icon = "__morebobs__/graphics/moreshiny/icons/warfare/flame-rocket.png"
		data.raw["ammo"]["bob-flame-rocket"].icon_size = 32
	end
	if data.raw["ammo"]["bob-acid-rocket"] then
		data.raw["ammo"]["bob-acid-rocket"].icon = "__morebobs__/graphics/moreshiny/icons/warfare/acid-rocket.png"
		data.raw["ammo"]["bob-acid-rocket"].icon_size = 32
	end
	if data.raw["ammo"]["bob-poison-rocket"] then
		data.raw["ammo"]["bob-poison-rocket"].icon = "__morebobs__/graphics/moreshiny/icons/warfare/poison-rocket.png"
		data.raw["ammo"]["bob-poison-rocket"].icon_size = 32
	end
	if data.raw["ammo"]["bob-electric-rocket"] then
		data.raw["ammo"]["bob-electric-rocket"].icon = "__morebobs__/graphics/moreshiny/icons/warfare/electric-rocket.png"
		data.raw["ammo"]["bob-electric-rocket"].icon_size = 32
	end
	if data.raw["ammo"]["bob-explosive-rocket"] then
		data.raw["ammo"]["bob-explosive-rocket"].icon = "__morebobs__/graphics/moreshiny/icons/warfare/explosive-rocket.png"
		data.raw["ammo"]["bob-explosive-rocket"].icon_size = 32
	end
	if data.raw["ammo"]["bob-impact-rocket"] then
		data.raw["ammo"]["bob-impact-rocket"].icon = "__morebobs__/graphics/moreshiny/icons/warfare/impact-rocket.png"
		data.raw["ammo"]["bob-impact-rocket"].icon_size = 32
	end
	
	if data.raw["ammo"]["poison-artillery-shell"] then
		data.raw["ammo"]["poison-artillery-shell"].icon = "__morebobs__/graphics/moreshiny/icons/warfare/poison-artillery-shell.png"
		data.raw["ammo"]["poison-artillery-shell"].icon_size = 32
	end
	if data.raw["ammo"]["explosive-artillery-shell"] then
		data.raw["ammo"]["explosive-artillery-shell"].icon = "__morebobs__/graphics/moreshiny/icons/warfare/explosive-artillery-shell.png"
		data.raw["ammo"]["explosive-artillery-shell"].icon_size = 32
	end
	if data.raw["ammo"]["distractor-artillery-shell"] then
		data.raw["ammo"]["distractor-artillery-shell"].icon = "__morebobs__/graphics/moreshiny/icons/warfare/distractor-artillery-shell.png"
