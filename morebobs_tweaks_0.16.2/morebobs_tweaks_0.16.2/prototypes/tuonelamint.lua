...
data:extend({
	-- item
	{
		type = "item",
		name = "burner-mint",
		icon = "__morebobs_tweaks__/graphics/icons/mint1.png",
		icon_size=64,
	...
	},
	{
		type = "item",
		name = "electric-mint",
		icon = "__morebobs_tweaks__/graphics/icons/mint2.png",
		icon_size=64,
		flags = {"goes-to-quickbar"},
		subgroup = "production-machine",
		order = "tu-b-02",
	...
	-- entity
	{
		...
		animation =
		{
			...
			{
				{
					filename = "__morebobs_tweaks__/graphics/entity/mint/mint1.png",
					priority = "high",
					width = 133,
					height = 123,
					frame_count = 1,
	...
	},
	{
		...
		animation =
		{
			...
			{
				{
					filename = "__morebobs_tweaks__/graphics/entity/mint/mint2.png",
					priority = "high",
					width = 169,
					height = 145,
					frame_count = 1,
