	...
	data:extend({
		{
			type = "capsule",
			name = "supply_box_b",
			icon = "__morebobs_tweaks__/graphics/icons/supply_box_b.png",
			icon_size = 32,
...
data:extend({
	-- main-base
  {
    ...
    icon = "__morebobs_tweaks__/graphics/icons/rescue-signal-generator.png",
    flags = {"goes-to-quickbar"},
  ...
  },
  {
		...
		icon = "__morebobs_tweaks__/graphics/icons/rescue-signal-generator.png",
		icon_size=32,
		flags = {"placeable-player", "player-creation", "not-repairable", "not-deconstructable"},
    ...
    pictures =
    {
      filename = "__morebobs_tweaks__/graphics/entity/rsg/rescue-signal-generator.png",
      priority = "low",
      width = 126,
      height = 180,
    ...
    working_sound =
    {
      sound =
			{
        {
          filename = "__morebobs_tweaks__/sounds/rescue-signal-generator.ogg"
        }
      },
      apparent_volume = 2,
    },
	...
	-- supply_box
  {
    type = "capsule",
    name = "supply_box_g",
    icon = "__morebobs_tweaks__/graphics/icons/supply_box_g.png",
    icon_size = 32,
    flags = {"goes-to-quickbar"},
    capsule_action =
    {
  ...
  },
  {
    type = "capsule",
    name = "supply_box_y",
    icon = "__morebobs_tweaks__/graphics/icons/supply_box_y.png",
    icon_size = 32,
    flags = {"goes-to-quickbar"},
    capsule_action =
    {
  ...
  },
	{
		...
		{
			{
				filename = "__morebobs_tweaks__/graphics/icons/null.png",
				priority = "extra-high",
				width = 32,
				height = 32,
				frame_count = 1,
		...
		sound =
		{
			...
			{
				{
					filename = "__morebobs_tweaks__/sounds/box.ogg",
					volume = 0.8
				},
			}
		},
...
data:extend({
  {
      ...
      action_delivery =
      {
        ...
        target_effects =
        {
					...
					},
					{
						...
						{
							{
								filename = "__morebobs_tweaks__/sounds/repair.ogg",
								volume = 0.65
							}
						},
					},
    ...
    animation =
		{
			filename = "__morebobs_tweaks__/graphics/icons/repair-capsule.png",
			flags = { "no-crop" },
			frame_count = 1,
			width = 32,
			height = 32,
    ...
    shadow =
		{
			filename = "__morebobs_tweaks__/graphics/icons/combat-robot-capsule-shadow.png",
			frame_count = 1,
			width = 32,
			height = 32,
			priority = "high"
  ...
  },
  {
    type = "capsule",
    name = "repair-capsule",
    icon = "__morebobs_tweaks__/graphics/icons/repair-capsule.png",
    icon_size = 32,
    flags = {"goes-to-quickbar"},
    capsule_action =
    {
      ...
      attack_parameters =
      {
		...
		subgroup = "capsule",
		order = "ca[repair-capsule]",
		stack_size = 100
  },
})
table.insert(data.raw["technology"]["construction-robotics"].effects,{type="unlock-recipe",recipe="repair-capsule"})
