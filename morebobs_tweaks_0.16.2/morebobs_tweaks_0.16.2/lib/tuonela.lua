...
local function on_supply_box_modules(player, chance, cnt, textpos)
	if chance <= 50 then
		if_can_insert(player, "craft-assistent-equipment", cnt, player.position, textpos)
	elseif chance > 50 and chance <= 80 then
		if_can_insert(player, "artificial-organ-equipment", cnt, player.position, textpos)
	elseif chance > 80 and chance <= 100 then
		if_can_insert(player, "combet-control-module-equipment", cnt, player.position, textpos)
	end
end
...
function on_supply_box_open_black(player_index)
  local player = game.players[player_index]
	...
	if game.item_prototypes["portable-engine-equipment"] == nil then
	...
	elseif box_chance_1 > 0 and box_chance_1 <= 25 then
		...
		if_can_insert(player, "armor-pocket-equipment", 1, player.position, 1)
		if_can_insert(player, "additional-toolbelt-equipment", 1, player.position, 1.5)
		if_can_insert(player, "battery-equipment", 1, player.position, 2)
		if_can_insert(player, "portable-logistic-computer-equipment", 3, player.position, 2.5)
		if_can_insert(player, "portable-autotrash-computer-equipment", 3, player.position, 3)
	...
	elseif box_chance_1 > 55 and box_chance_1 <= 65 then
		...
		if_can_insert(player, "armor-pocket-equipment", 2, player.position, 1.5)
	...
	elseif box_chance_1 > 65 and box_chance_1 <= 75 then
		...
		if_can_insert(player, "battery-equipment", 1, player.position, 2.5)
		if_can_insert(player, "portable-logistic-computer-equipment", 2, player.position, 3.5)
		if_can_insert(player, "portable-autotrash-computer-equipment", 2, player.position, 4)
	...
	elseif box_chance_1 > 75 and box_chance_1 <= 85 then
		...
		if_can_insert(player, "battery-equipment", 2, player.position, 2)
		if_can_insert(player, "portable-logistic-computer-equipment", 2, player.position, 2.5)
		if_can_insert(player, "portable-autotrash-computer-equipment", 2, player.position, 3)
...
function on_supply_box_open_green(player_index)
  local player = game.players[player_index]
	...
	elseif box_chance_1 > 73 and box_chance_1 <= 78 then
		cnt = math.random(5,100)
		if game.item_prototypes["first-aid-kit"] == nil then
			if_can_insert(player, "raw-fish", cnt*5, player.position, 0.5)
		else
			if_can_insert(player, "first-aid-kit", cnt, player.position, 0.5)
		end
	elseif box_chance_1 > 78 and box_chance_1 <= 100 then
...
if settings.global["start-with-supply-box-b"] and settings.global["start-with-supply-box-b"].value == true then
