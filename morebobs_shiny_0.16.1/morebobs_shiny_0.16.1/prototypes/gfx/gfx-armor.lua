...
if data.raw["armor"]["heavy-armor-3"] then
	table.insert(data.raw.player.player.animations, bobsarmor)
end

if data.raw["armor"]["bob-power-armor-mk5"] or data.raw["armor"]["power-armor-mk5"] then
	table.insert(data.raw.player.player.animations, bobspowerarmor)
	if data.raw["armor"]["power-armor-mk5"] then
		data.raw["character-corpse"]["character-corpse"].armor_picture_mapping["power-armor-mk3"] = not data.is_demo and 3 or nil
		data.raw["character-corpse"]["character-corpse"].armor_picture_mapping["power-armor-mk4"] = not data.is_demo and 3 or nil
		data.raw["character-corpse"]["character-corpse"].armor_picture_mapping["power-armor-mk5"] = not data.is_demo and 3 or nil
	elseif data.raw["armor"]["bob-power-armor-mk5"] then
		data.raw["character-corpse"]["character-corpse"].armor_picture_mapping["bob-power-armor-mk3"] = not data.is_demo and 3 or nil
		data.raw["character-corpse"]["character-corpse"].armor_picture_mapping["bob-power-armor-mk4"] = not data.is_demo and 3 or nil
		data.raw["character-corpse"]["character-corpse"].armor_picture_mapping["bob-power-armor-mk5"] = not data.is_demo and 3 or nil
	end

	if mods["bobclasses"] then
		table.insert(data.raw["player"]["bob-player-miner"].animations, bobsarmor)
		table.insert(data.raw["player"]["bob-player-fighter"].animations, bobsarmor)
		table.insert(data.raw["player"]["bob-player-builder"].animations, bobsarmor)

		table.insert(data.raw["player"]["bob-player-miner"].animations, bobspowerarmor)
		table.insert(data.raw["player"]["bob-player-fighter"].animations, bobspowerarmor)
		table.insert(data.raw["player"]["bob-player-builder"].animations, bobspowerarmor)
	end

	if data.raw["armor"]["bob-power-armor-mk3"] then data.raw["armor"]["bob-power-armor-mk3"].icons =
		{
			{ icon = "__base__/graphics/icons/power-armor-mk2.png" }, 
			{ icon = "__morebobs_shiny__/graphics/mask/Bob-armor-mask.png", tint = { r=1, g=0.1, b=0.04 } }
		}
	end
	if data.raw["armor"]["bob-power-armor-mk4"] then data.raw["armor"]["bob-power-armor-mk4"].icons =
		{
			{ icon = "__base__/graphics/icons/power-armor-mk2.png" }, 
			{ icon = "__morebobs_shiny__/graphics/mask/Bob-armor-mask.png", tint = { r=0, g=0.4, b=1 } }
		}
	end
	if data.raw["armor"]["bob-power-armor-mk5"] then data.raw["armor"]["bob-power-armor-mk5"].icons =
		{
			{ icon = "__base__/graphics/icons/power-armor-mk2.png" }, 
			{ icon = "__morebobs_shiny__/graphics/mask/Bob-armor-mask.png", tint = { r=0.7, g=0.4, b=1 } }
		}
	end
	if data.raw["technology"]["bob-power-armor-3"] then data.raw["technology"]["bob-power-armor-3"].icons =
		{
			{ icon = "__base__/graphics/technology/power-armor-mk2.png" }, 
			{ icon = "__morebobs_shiny__/graphics/mask/Bob-armor-T-mask.png", tint = { r=1, g=0.1, b=0.04 } }
		}
	...
	if data.raw["technology"]["bob-power-armor-4"] then data.raw["technology"]["bob-power-armor-4"].icons =
		{
			{ icon = "__base__/graphics/technology/power-armor-mk2.png" }, 
			{ icon = "__morebobs_shiny__/graphics/mask/Bob-armor-T-mask.png", tint = { r=0, g=0.4, b=1 } }
		}
	...
	if data.raw["technology"]["bob-power-armor-5"] then data.raw["technology"]["bob-power-armor-5"].icons =
		{
			{ icon = "__base__/graphics/technology/power-armor-mk2.png" }, 
			{ icon = "__morebobs_shiny__/graphics/mask/Bob-armor-T-mask.png", tint = { r=0.7, g=0.4, b=1 } }
		}
