--greenhouses
	--greenhouse
if data.raw["item"]["bob-greenhouse"] then data.raw["item"]["bob-greenhouse"].icon = "__morebobs_shiny__/graphics/icons/greenhouses/greenhouse.png" end
...
if data.raw["assembling-machine"]["bob-greenhouse"] then
	function pipespictures_greenhouse_fix1()
		return {
			north =
			{
				filename = "__morebobs_shiny__/graphics/entity/greenhouses/pipe-north.png",
				priority = "extra-high",
				width = 64,
				height = 64,
	...
	{
		filename = "__morebobs_shiny__/graphics/entity/greenhouses/greenhouse.png",
		width = 113,
		height = 101,
		frame_count = 1,
		shift = {0.2, 0},
	...
	{
		{
			...
			animation =
			{
				filename = "__morebobs_shiny__/graphics/entity/greenhouses/greenhouse-lights.png",
				width = 113,
				height = 101,
				frame_count = 28,
				line_length = 7,
...
if data.raw["recipe"]["bob-basic-greenhouse-cycle"] then data.raw["recipe"]["bob-basic-greenhouse-cycle"].icon = "__morebobs_shiny__/graphics/icons/greenhouses/seedling-wood.png" end
...
if data.raw["recipe"]["bob-advanced-greenhouse-cycle"] then data.raw["recipe"]["bob-advanced-greenhouse-cycle"].icon = "__morebobs_shiny__/graphics/icons/greenhouses/seedling-fertilizer-wood.png" end
