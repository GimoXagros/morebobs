local bobs_overflow_pipe_names = {} do
	...
	local pic1 = "__morebobs_flowcontrol__/graphics/icons/pipe-"
	local pic2 = "__morebobs_flowcontrol__/graphics/entity/pipe/pipe-"
	local pic3 = "__morebobs_flowcontrol__/graphics/entity/pipe/hr-pipe-"
	...
	do -- These match the fluid areas listed in boblogistics_0.16.23\prototypes\entity\pipes.lua
	...
	do -- These match the fluid areas listed in boblogistics_0.16.23\prototypes\entity\pipes.lua
		...
		new_pipes[n.as].entity.fluid_box.pipe_covers = morebobscoverpictures("brass")
		new_pipes[n.aj].entity.fluid_box.pipe_covers = morebobscoverpictures("brass")
		new_pipes[n.ae].entity.fluid_box.pipe_covers = morebobscoverpictures("brass")
		new_pipes[n.bs].entity.fluid_box.pipe_covers = morebobscoverpictures("bronze")
		new_pipes[n.bj].entity.fluid_box.pipe_covers = morebobscoverpictures("bronze")
		new_pipes[n.be].entity.fluid_box.pipe_covers = morebobscoverpictures("bronze")
		...
		new_pipes[n.ts].entity.fluid_box.pipe_covers = morebobscoverpictures("titanium")
		new_pipes[n.tj].entity.fluid_box.pipe_covers = morebobscoverpictures("titanium")
		new_pipes[n.te].entity.fluid_box.pipe_covers = morebobscoverpictures("titanium")
		new_pipes[n.us].entity.fluid_box.pipe_covers = morebobscoverpictures("tungsten")
		new_pipes[n.uj].entity.fluid_box.pipe_covers = morebobscoverpictures("tungsten")
		new_pipes[n.ue].entity.fluid_box.pipe_covers = morebobscoverpictures("tungsten")
		new_pipes[n.es].entity.fluid_box.pipe_covers = morebobscoverpictures("ceramic")
		new_pipes[n.ej].entity.fluid_box.pipe_covers = morebobscoverpictures("ceramic")
		new_pipes[n.ee].entity.fluid_box.pipe_covers = morebobscoverpictures("ceramic")
	...
	do -- These match the fluid areas listed in boblogistics_0.16.23\prototypes\entity\pipes.lua
		...
		new_pipes[n.us].entity.max_health = 300
		new_pipes[n.uj].entity.max_health = 300
		new_pipes[n.ue].entity.max_health = 300
	...
	do -- These match the fluid areas listed in boblogistics_0.16.23\prototypes\entity\pipes.lua
		...
		new_pipes[n.as].entity.resistances = { { type = "fire", percent = 90 } }
		new_pipes[n.aj].entity.resistances = { { type = "fire", percent = 90 } }
		new_pipes[n.ae].entity.resistances = { { type = "fire", percent = 90 } }
		new_pipes[n.bs].entity.resistances = { { type = "fire", percent = 90 } }
		new_pipes[n.bj].entity.resistances = { { type = "fire", percent = 90 } }
		new_pipes[n.be].entity.resistances = { { type = "fire", percent = 90 } }
		...
		new_pipes[n.ts].entity.resistances = { { type = "fire", percent = 90 } }
		new_pipes[n.tj].entity.resistances = { { type = "fire", percent = 90 } }
		new_pipes[n.te].entity.resistances = { { type = "fire", percent = 90 } }
		new_pipes[n.us].entity.resistances = { { type = "fire", percent = 90 } }
		new_pipes[n.uj].entity.resistances = { { type = "fire", percent = 90 } }
		new_pipes[n.ue].entity.resistances = { { type = "fire", percent = 90 } }
		new_pipes[n.es].entity.resistances = { { type = "fire", percent = 90 } }
		new_pipes[n.ej].entity.resistances = { { type = "fire", percent = 90 } }
		new_pipes[n.ee].entity.resistances = { { type = "fire", percent = 90 } }
	...
	-- Add to appropriate technologies (based on when they unlock in bobplates_0.16.5\prototypes\technology*.lua)
